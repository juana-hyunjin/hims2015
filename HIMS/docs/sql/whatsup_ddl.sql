...
CREATE SEQUENCE EVENT_PART_SEQ
START WITH 1
INCREMENT BY 1;

ALTER TABLE EVENT_PART
ADD CONSTRAINT FK_EVENT_PART_USERID FOREIGN KEY(USERID)
REFERENCES MEMBER(USERID);

ALTER TABLE EVENT_PART
ADD CONSTRAINT FK_EVENT_PART_EVENT_NO FOREIGN KEY(EVENT_NO)
REFERENCES EVENT(EVENT_NO);

ALTER TABLE EVENT_PART
ADD CONSTRAINT  PK_EVENT_PART_USERID	PRIMARY KEY(USERID, EVENT_NO);
